...
import { BodyDetail } from 'src/@generated/body-detail/body-detail.model';
import { CurrentUser } from 'src/auth/decorators/user.decorator.graphql';
import { BodyDetailService } from './body-detail.service';
import { BodyDetailCreateWithoutUserInput } from 'src/@generated/body-detail/body-detail-create-without-user.input';
