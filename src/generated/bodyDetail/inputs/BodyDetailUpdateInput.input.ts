...
import { UserUpdateOneRequiredWithoutBodyDetailNestedInput } from "../../user/inputs/UserUpdateOneRequiredWithoutBodyDetailNestedInput.input";

@NestJsGraphQL.InputType('BodyDetailUpdateInput', { isAbstract: true })
export class BodyDetailUpdateInput {
  ...
  @NestJsGraphQL.Field(() => UserUpdateOneRequiredWithoutBodyDetailNestedInput, { nullable: true })
  user?: UserUpdateOneRequiredWithoutBodyDetailNestedInput | undefined;
}
