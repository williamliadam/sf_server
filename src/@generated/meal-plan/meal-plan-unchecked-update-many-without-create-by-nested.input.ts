...
export class MealPlanUncheckedUpdateManyWithoutCreateByNestedInput {
	...
	@Field(() => [MealPlanUpsertWithWhereUniqueWithoutCreateByInput], {
		nullable: true,
	})
