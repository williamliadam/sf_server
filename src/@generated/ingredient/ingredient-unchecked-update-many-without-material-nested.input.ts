...
@InputType()
export class IngredientUncheckedUpdateManyWithoutMaterialNestedInput {
    ...
    @Field(() => [IngredientCreateOrConnectWithoutMaterialInput], {nullable:true})
    @Type(() => IngredientCreateOrConnectWithoutMaterialInput)
    connectOrCreate?: Array<IngredientCreateOrConnectWithoutMaterialInput>;

    @Field(() => [IngredientUpsertWithWhereUniqueWithoutMaterialInput], {nullable:true})
    ...
    @Field(() => [IngredientUpdateWithWhereUniqueWithoutMaterialInput], {nullable:true})
    @Type(() => IngredientUpdateWithWhereUniqueWithoutMaterialInput)
    update?: Array<IngredientUpdateWithWhereUniqueWithoutMaterialInput>;

    @Field(() => [IngredientUpdateManyWithWhereWithoutMaterialInput], {nullable:true})
